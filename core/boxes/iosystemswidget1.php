...
/**
 * \file    modulebuilder/template/core/boxes/iosystemswidget1.php
 * \ingroup iosystems
 * \brief   Widget provided by iosystems
 *
 ...
 */
class iosystemswidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "iosystemsbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "iosystems@iosystems";
	 ...
	 */
	public $depends = array('iosystems');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->iosystems->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/iosystems/class/iosystems.class.php";

		// Populate the head at runtime
		$text = $langs->trans("iosystemsBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_iosystems@iosystems',
