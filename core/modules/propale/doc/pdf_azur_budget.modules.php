...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_azur_budget.modules.php
 *	\ingroup    propale
 ...
 */
class pdf_azur_budget extends ModelePDFPropales
{
	/**
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "azur budget";
		$this->description = "Proposition budgétaire";
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		if ($conf->propal->multidir_output[$conf->entity])
		{
			...
			if (file_exists($dir))
			{
				...
				$pdf->SetSubject($outputlangs->transnoentities("BudgetProposal"));
				$pdf->SetCreator("Dolibarr ".DOL_VERSION);
				$pdf->SetAuthor($outputlangs->convToOutputCharset($user->getFullName($outputlangs)));
				$pdf->SetKeyWords($outputlangs->convToOutputCharset($object->ref)." ".$outputlangs->transnoentities("BudgetProposal")." ".$outputlangs->convToOutputCharset($object->thirdparty->name));
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		$pdf->SetXY($posx,$posy);
		$pdf->SetTextColor(0,0,60);
		$title=$outputlangs->transnoentities("BudgetProposal");
