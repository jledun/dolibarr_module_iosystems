...
/**
 * \file    test/functional/iosystemsFunctionalTest.php
 * \ingroup iosystems
 ...
 *
 * @package Testiosystems
 */
class iosystemsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modiosystems')->click();
		} else {
			// Disable the module
			$this->byHref('modiosystems')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/iosystems/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('iosystems/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/iosystems/admin/about.php');
		$this->authenticate();
		return $this->assertContains('iosystems/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('iosystemswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modiosystems_iosystemsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modiosystems_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
