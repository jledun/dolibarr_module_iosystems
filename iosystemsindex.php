...
/**
 *	\file       htdocs/iosystems/template/iosystemsindex.php
 *	\ingroup    iosystems
 *	\brief      Home page of iosystems top menu
 */
...
$langs->loadLangs(array("iosystems@iosystems"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->iosystems->read) accessforbidden();
...
llxHeader("",$langs->trans("iosystemsArea"));

print load_fiche_titre($langs->trans("iosystemsArea"),'','iosystems.png@iosystems');
...
// Draft MyObject
if (! empty($conf->iosystems->enabled) && $user->rights->iosystems->read)
{
	$langs->load("orders");
